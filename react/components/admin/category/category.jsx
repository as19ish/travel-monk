...
class Category_table extends React.Component {
  constructor(props) {
    super(props);
    this.state = {data:[],
                  id_selected:'',
 ...
 axios({
                                ...
                                .then(response=> {
                                    ...
                                    document.getElementById('success_message14').style.display='block';
                                    window.setTimeout(function() {
                                        $(".alert14").fadeTo(500, 0).slideUp(500, function(){

                                                                     $(".alert14").fadeTo(500, 1)
                                                                     document.getElementById('success_message14').style.display='none';
  ...
  if(this.state.data.length!=0)
  {
    ...
    return (
            <div>
            <div id='success_message14' className="alert14 alert-success14" role="alert" style={{display: 'none',borderRadius:'15px'}}>
           <div className="form_success_msg14">
...
<div id='success_message1' className="alert1 alert-success1" style={{display: 'none',borderRadius:'15px'}}>
  ...
  <strong>Success!</strong>
     ...
     <fieldset>
        <legend style={{textTransform:'uppercase'}}>Category Form</legend>
          <div className="form-group">
            <input type="text" name="name" style={{backgroundColor:'white'}} value={this.state.name} onChange={this.name_handleChange} className="form-control1" id="nameImput" placeholder="Category" />
          </div>

          <div className="form-group">
            <textarea name="description" type="number"  style={{backgroundColor:'white'}} onChange={this.description_handleChange} className="form-control1" rows="5" cols="20" id="description" placeholder="Description">{this.state.description}</textarea>
          </div>
...
<Category_table data={this.state.result}/>
