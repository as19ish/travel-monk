...
SECRET_KEY = '%z@jmh8qtupx_$w63pvh=jj3j=d$u499(!!1s9%bz2161#dmk5'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'tourism_project/template')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#root shows-> shows where to upload in django when submitted from UI.  path relative to django project not app..
